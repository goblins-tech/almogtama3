/*
as of Angular 9 there isno @angular/material/index.d.ts
so we need to import each module from a separate folder.

import * from @angular/material will not work any more.
